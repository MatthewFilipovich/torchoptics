...
def test_plane_sample():
    ...
    sampled_plane0 = plane_sample(data, data_plane, interpolate_plane0, "bilinear", "zeros")
    ...
    sampled_plane1 = plane_sample(data, data_plane, interpolate_plane1, "bilinear", "zeros")
    ...
    sampled_plane2 = plane_sample(data, data_plane, interpolated_plane2, "bilinear", "zeros")
    ...
    sampled_plane3 = plane_sample(data, data_plane, interpolated_plane3, "bilinear", "zeros")
    ...
    sampled_plane4 = plane_sample(data, data_plane, interpolated_plane4, "bilinear", "zeros")
