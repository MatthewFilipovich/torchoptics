...
__all__ = ["spherical_wave", "plane_wave"]
...
def spherical_wave(
    ...
    Args:
        ...
        spacing (Optional[Vector2]): Grid spacing. Defaults to global setting.
        offset (Optional[Vector2]): Grid center. Defaults to (0, 0).
...
def plane_wave(
    ...
    Args:
        ...
        spacing (Optional[Vector2]): Grid spacing. If None, uses global default.
        offset (Optional[Vector2]): Grid offset. If None, defaults to (0, 0).
    ...
    # Direction components of wavevector
